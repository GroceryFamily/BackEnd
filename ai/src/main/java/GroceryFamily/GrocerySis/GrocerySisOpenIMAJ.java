...
public class GrocerySisOpenIMAJ {
    /**
     * Main method
     *
     * @param args ignored
    ...
    public static void main(String[] args) throws IOException {
        ...
        final String input_1Str = "/prisma/piim-alma-2.5%-1.5l.png";
//        final String input_2Str = "/prisma/piim-alma-0.05%-1.0l.png";
//        final String input_2Str = "/prisma/piim-tere-1.8%-1.5l.png";
//        final String input_2Str = "/prisma/piim-alma-2.5%-1.0l-kilepakis.png";
//        final String input_2Str = "/prisma/piim-alma-2.5%-0.5l.png";
//        final String input_2Str = "/prisma/piim-alma-2.5%-1.5l.png";
//        final String input_2Str = "/rimi/piim-alma-2.5%-1.5l.jpeg";
        final String input_2Str = "/rimi/piim-alma-2.5%-1.0l.jpeg";
        final FImage input_1 = ImageUtilities.readF(GrocerySis.class.getResourceAsStream(input_1Str));
        final FImage input_2 = ImageUtilities.readF(GrocerySis.class.getResourceAsStream(input_2Str));

        // Prepare the engine to the parameters in the IPOL demo
        final ASIFTEngine engine = new ASIFTEngine(true, 7);
